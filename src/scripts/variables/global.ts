...
const App = function (): AppConfig {
    ...
    for (const [pos, key] of keys.entries()) {
        if (pos < (keys.length - 2))
            ...
            Object.defineProperty((entries as AppConfig), key, {
                value:
                    (pos + 1) === keys.length ? function (): boolean {
                        // @ts-ignore
                        return entries.ComponentsState && entries.EventsState && entries.RuntimeErrorListenerState && entries.RuntimeToolsState
                    } : function (key: AppStatesConfigKeys, state: boolean): void {
                        // @ts-ignore
                        if (entries[key] === null || entries[key] === undefined) {
                            console.error(`App>UpdateState(@${key}: Unknown-Property): Key '${key}' is unknown property of variable @App! (Exited)`);
                            return;
                        }

                        if (typeof state !== "boolean") {
                            console.error(`App>UpdateState(@state: non-boolean-value): Expects a TRUE or FALSE value as its representative state! (Exited)`);
                            return;
                        }
 ...
 */
const SVGPaths = Object.defineProperties({}, {
    Apps: {
    ...
    Book: {
        value: "M249.23-120q-37.18 0-63.2-25.58Q160-171.15 160-207.69v-543.08q0-37.18 26.03-63.2Q212.05-840 249.23-840h415.39v584.62H249.23q-20.08 0-34.65 13.67Q200-228.04 200-207.83t14.58 34.02Q229.15-160 249.23-160H760v-600h40v640H249.23Zm86.15-175.38h289.24V-800H335.38v504.62Zm-40 0V-800h-46.15q-20.92 0-35.08 14.58Q200-770.85 200-750.77v471.62q10.77-6.85 22.95-11.54 12.18-4.69 26.28-4.69h46.15ZM200-800v520.85V-800Z",
        writable: false,
        configurable: false,
        enumerable: true
    },
    Clock: {
        value: "M597.38-311.08 460-448.46v-194.62h40v178.54l124.92 124.92-27.54 28.54ZM460-720v-80h40v80h-40Zm260 260v-40h80v40h-80ZM460-160v-80h40v80h-40ZM160-460v-40h80v40h-80Zm320.13 340q-74.67 0-140.41-28.34-65.73-28.34-114.36-76.92-48.63-48.58-76.99-114.26Q120-405.19 120-479.87q0-74.67 28.34-140.41 28.34-65.73 76.92-114.36 48.58-48.63 114.26-76.99Q405.19-840 479.87-840q74.67 0 140.41 28.34 65.73 28.34 114.36 76.92 48.63 48.58 76.99 114.26Q840-554.81 840-480.13q0 74.67-28.34 140.41-28.34 65.73-76.92 114.36-48.58 48.63-114.26 76.99Q554.81-120 480.13-120Zm-.13-40q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z",
        writable: false,
        configurable: false,
        enumerable: true
    },
    Home: {
        value: "M240-200h147.69v-235.38h184.62V-200H720v-360L480-741.54 240-560v360Zm-40 40v-420l280-211.54L760-580v420H532.31v-235.38H427.69V-160H200Zm280-310.77Z",
        writable: false,
        configurable: false,
        enumerable: false
    },
    Settings: {
        value: "M463.08-310.77h33.84l7.39-49.23q22.77-5 37.5-13.19t28.04-23.12l47.23 18 17.69-29.54-37.54-30.77q6.62-21.69 6.62-41.38t-6.62-41.38l37.54-30.77-17.69-29.54-47.23 18q-13.31-14.93-28.04-23.12-14.73-8.19-37.5-13.19l-7.39-49.23h-33.84L455.69-600q-22.77 5-37.5 13.19t-28.04 23.12l-47.23-18-17.69 29.54 37.54 30.77q-6.62 21.69-6.62 41.38t6.62 41.38l-37.54 30.77 17.69 29.54 47.23-18q13.31 14.93 28.04 23.12 14.73 8.19 37.5 13.19l7.39 49.23ZM480-400q-33 0-56.5-23.5T400-480q0-33 23.5-56.5T480-560q33 0 56.5 23.5T560-480q0 33-23.5 56.5T480-400ZM224.62-160q-27.62 0-46.12-18.5Q160-197 160-224.62v-510.76q0-27.62 18.5-46.12Q197-800 224.62-800h510.76q27.62 0 46.12 18.5Q800-763 800-735.38v510.76q0 27.62-18.5 46.12Q763-160 735.38-160H224.62Zm0-40h510.76q9.24 0 16.93-7.69 7.69-7.69 7.69-16.93v-510.76q0-9.24-7.69-16.93-7.69-7.69-16.93-7.69H224.62q-9.24 0-16.93 7.69-7.69 7.69-7.69 16.93v510.76q0 9.24 7.69 16.93 7.69 7.69 16.93 7.69ZM200-760v560-560Z",
        writable: false,
        configurable: false,
        enumerable: true
    },
    UnknownDocument: {
        value: "M200-800v259-3 384-640 148-148Zm106 374h127q5-8 10-14.5t10-13.5H306v28Zm0 160h92q-1-7-1.5-14t-.5-14h-90v28Zm-74 134q-26 0-43-17t-17-43v-576q0-26 17-43t43-17h314l162 162v130q-7-2-13.5-3t-14.5-2v-111H532v-148H232q-12 0-22 10t-10 22v576q0 12 10 22t22 10h204q5 8 10.5 14.5T458-132H232Zm412-312q62 0 105 43t43 105q0 62-43 105t-105 43q-62 0-105-43t-43-105q0-62 43-105t105-43Zm0 260q8 0 14-6t6-14q0-8-6-14t-14-6q-8 0-14 6t-6 14q0 8 6 14t14 6Zm-14-70h28v-6q0-12 6-19t14-15q14-12 22-25t8-31q0-27-17.5-44.5T644-412q-21 0-39.5 13.5T578-364l26 10q5-12 15.5-21t24.5-9q17 0 26.5 8.5T680-350q0 12-7 20t-15 16q-6 6-11.5 13T636-288q-3 5-4.5 11.5T630-264v10Z",
        writable: false,
        configurable: false,
        enumerable: true,
    }
 ...
 */
const View = DOM.getElementById("view") ?? DOM.body;
